...
Είναι φανερό ότι υπάρχει βελτίωση στην ταχύτητα με την αύξηση του ρολογιού. Παρόλα αυτά δεν υπάρχει γραμικότητα και τέλειο calling. Αυτό συμβαίνει διότι με την αυξηση του ρολογιού δεν μειώθηκαν τα miss-rates επομένως η καθυστέριση που εισάγει στην εξίσωστη η cache παραμένει η ίδια. Αυτό φαίνεται και πιο έντονα στο **Speclibm** που είχει πολύ μεγάλα miss-rate αρα πολύ μεγάλη καθυστέριση που προέρχονταν από την Cache. Για αυτού του είδος τα προβλήματα δεν υπάρχει τέλειο Scaling ως προς την ταχύτητα ρολογιου
